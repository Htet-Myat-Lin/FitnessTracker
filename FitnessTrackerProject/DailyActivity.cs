    ...
    public partial class DailyActivity : Form
    {
        ...
        private string AutoID()
        {
            ...
            else
            {
                ...
                noOfRow++;
                string newID = "R-" + noOfRow.ToString("0000");
                return newID;
            }
        }
        ...
        //if user selects an activity name, ActivityID and METs of selected activity are displayed
        ...
        private void btnsave_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Please Add First", "MyFitness", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}
